              ...
              <div class="justify-content-center">
                  <div class="card text-center areaLogin w-75 mx-auto p-4">
                      <div class="row">
                         ...
                         ?>
                          <form class="p-4" name="CadastrarImagem" method="POST" action="guardarArquivo.php" enctype="multipart/form-data">
                              ...
                              <label class="labelFormulario mt-5 pb-2">Descrição da Imagem</label>
                              <input type="text" class="form-control text-center" name="txtDescImagem" id="txtDescImagem" placeholder="Ex: Quadro: Galatea de Esferas" required>
