...
<head>
  <meta charset="UTF-8">
  <title>Cadastrar Categoria da Obra</title>
          ...
          <div class="card text-center areaLogin w-75 mx-auto p-4">
            <div class="row">
              <form class="p-4" name="CadastrarObra" method="POST" action="../inserir-categoria.php">
                ...
                <input type="text" class="form-control text-center" id="txtCategoriaObra" name="txtCategoriaObra"
                  placeholder="Ex: Quadro, Escultura, etc..." required>
                <div class="row pl-2 pr-2 mt-5">
                  <button type="submit" value="CadastrarObra" onclick=avisar()
                    class="btn-cadastro btn-block btn-lg btn-outline-warning">Cadastrar Período</button>
                  <script>
                    function avisar() {
                      alert("Tipo de obra cadastrado no banco de dados com sucesso");
                    }
                  </script>
                </div>
              </form>
