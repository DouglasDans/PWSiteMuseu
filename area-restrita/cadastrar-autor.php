...
?>
  ...
  <div class="view pt-5 pb-5"
    style="background-image: url(../img/obras/Galacidalacidesoxyribonucleicacid.jpg); background-repeat:no-repeat; background-size:cover; background-position: center center">
    <div>
      <div class="container mt-4 mb-4">
        <div class="justify-content-center">
          <div class="card text-center areaLogin w-75 mx-auto p-4">
            <div class="row">
              <form class="p-4" name="CadastrarAutor" method="POST" action="../inserir-autor.php">
                ...
                <input type="text" class="form-control text-center" name="txtNomeAutor" id="txtNomeAutor"
                  placeholder="Ex: Salvador Dalí..." required>
                <label for="txtDataNascAutor" class="labelFormulario mt-5 pb-2">Data de Nascimento do Autor</label>
                <input type="date" class="form-control text-center" name="txtDataNascAutor" id="txtDataNascAutor"
                  required>
                <div class="row pl-2 pr-2 mt-5">
                  <button type="submit" value="CadastrarAutor" onclick=avisar()
                    class="btn-cadastro btn-block btn-lg btn-outline-warning">Cadastrar Autor</button>
                  <script>
                    function avisar() {
                      alert("Autor cadastrado no banco de dados com sucesso");
                    }
                  </script>
                </div>
              </form>
